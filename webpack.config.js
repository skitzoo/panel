...
// directory where compiled assets will be stored
    ...
    .addEntry('js/fontawesome', './assets/js/fontawesome.js')
    ...
    .addStyleEntry('css/bootstrap-datepicker', './assets/css/bootstrap-datepicker.scss')
    .addStyleEntry('css/fontawesome', './assets/css/fontawesome.scss')
    .addStyleEntry('css/coreui', './assets/css/coreui.scss')
...
//.enableReactPreset()
//.addEntry('admin', './assets/js/main.js')
;
